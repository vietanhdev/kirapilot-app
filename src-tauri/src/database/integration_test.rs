...
mod integration_tests {
    use crate::database::{
        get_migration_status, initialize_database, test_migration_compatibility,
    };
    ...
    async fn test_database_initialization_with_migrations() {
        ...
        assert!(
            ...
            "Database should be up to date after initialization"
        );
    ...
    async fn test_migration_compatibility_integration() {
        ...
        assert!(
            result.is_ok(),
            "Migration compatibility test should pass: {:?}",
            result
        );
        ...
        assert!(
            ...
            "Forward compatibility should pass"
        );
        assert!(
            test_result.backward_compatibility,
            "Backward compatibility should pass"
        );
    }
}
