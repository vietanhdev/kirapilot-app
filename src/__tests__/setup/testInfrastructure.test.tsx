...
describe('Test Infrastructure', () => {
  ...
  describe('Test Utilities', () => {
    ...
    it('should support custom initial state', () => {
      ...
      const { mockServices } = renderWithProviders(<TestComponent />, {
        initialState,
        mockServices: {
  ...
  describe('Test Data Factory', () => {
    ...
    it('should reset ID counter', () => {
      TestDataFactory.createTask(); // Create a task to increment counter
      TestDataFactory.resetIdCounter();
  ...
  describe('Mock AI Service', () => {
    ...
    it('should execute actions', async () => {
      ...
      const result = await mockAI.executeAction(action);
